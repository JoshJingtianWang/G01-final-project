...
silver_station_info_df = (
    bronze_station_info_df
    # Null values in region_id, etc.
    # Explode the rental_methods column
)
...
silver_station_status_df = (
    bronze_station_status_df
    # Data imputation for num_scooters columns
    # Convert last_reported from unix time
    # Last few columns might be completely null
)
...
silver_nyc_weather_df = (
    bronze_nyc_weather_df
    # Same transformations as the historical weather table
    # Convert wind_gust column to mph
    # Explode weather column into multiple rows/columns
)
